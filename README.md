...
### 桌面玩偶「伙伴」（v1.4.0 猫娘工程师）

工作台右下角常驻一只 **猫娘工程师** 桌宠——灰色猫耳与蓬松大尾巴、头戴工程师耳机、蓝色工装背带裤，它会**跟随你的工作状态变化**：

| 状态 | 表现 |
|---|---|
| 待机 | 抱着电路板，微笑浮动 |
| 专注中（番茄钟运行） | 低头看电路板、拿电烙铁认真焊接 |
| 休息中（短/长休息） | 闭眼捧一杯热咖啡 |
| 完成时（番茄阶段结束 / 待办勾选完成） | 举手跳跃大笑 + 彩色纸屑星星 |
| 久坐时（空闲 60 秒） | 趴桌打盹冒 Zzz，戳一下唤醒 |

- 点击玩偶，它会随机回你一句工程师台词
- **按住玩偶可以拖拽到工作台任意位置**：拖拽时有"拎起"悬浮感，靠近屏幕边缘自动吸附贴边，窗口变化自动校正位置
- 「伙伴」标签页：给玩偶**改名字**、**调整大小**（60–150px）、**开关常驻显示**
- 呼吸浮动动画、庆祝粒子、随机歪头卖萌，气泡为毛玻璃风格；深色 / 浅色主题下都能正常显示

猫娘工程师的五种状态：

![猫娘工程师五种状态](images/screenshots/pet-cat-moods.png)
